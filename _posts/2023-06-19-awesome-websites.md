...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [Guia do mapa 3D de Game of Thrones](https://alex2wong.github.io/Game-of-Throne-Map/index.html) |
| [150 efeitos CSS](https://1stwebdesigner.com/css-effects/) | 150 exemplos incríveis de animação e efeitos CSS |
| [2018 Make Me Pulse](http://2018.makemepulse.com/) | Use canvas para desenhar os quatro números de 2018, os efeitos especiais são ótimos |
| [68Design](http://www.68design.net/cool/) | Coleta especialmente sites estrangeiros de alta qualidade e os atualiza regularmente, muito legal |
| [Animista](http://animista.net) | Gere diversas animações CSS online | `Animação CSS` |
| [ASCIIFlow Infinity](http://asciiflow.com/) | Use caracteres ASCII para desenhar, você pode ajustar o tamanho, desenhar livremente e desenhar códigos semelhantes a Buda. | `ACSII`, `código` |
| [bellwoods](https://bellwoods.xyz/) | Siga os pássaros na grama alta para perseguir o vento e explorar as cores coloridas |
| [Biblioteca de padrões de Bennett Feely](http://bennettfeely.com/gradients/) | Padrões de gradiente CSS gerados usando modos de mesclagem |
| [BonBon](http://simurai.com/archive/buttons/) | Simurai levou o raio da borda ao extremo com sua técnica excelente, e seus botões de doces mostram vários formatos maravilhosos | `raio da fronteira` |
| [Browserhacks](http://browserhacks.com/) | Browserhacks é uma lista de Hacks CSS e JavaScript específicos. | `Hackear`, `CSS`, `JS` |
| [Codepip](https://codepip.com/) | Você pode encontrar alguns jogos educativos e divertidos aqui, atualmente existem Flexbox e CSS Grid | `Game`, `Flexbox`, `Grid` |
| [Codrops](https://tympanus.net/codrops/) | Possui diversas animações visuais e interativas que podem ser visualizadas online, e cada caso é acompanhado de código. | `animação`, `recursos` |
| [Condutor](http://www.mta.me/) | Algumas linhas maravilhosas, avançando e se cruzando constantemente, e também girando 90 graus, mostrando elasticidade quando se encontram, e as cores das linhas e do fundo continuarão mudando ., mas todos eles têm seu próprio ciclo de vida, quando o tempo acabar, eles desaparecerão na cortina e verão o que estão pintando. | `Criatividade` |
...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [TinyURL](https://tinyurl.com/) | Pode converter o URL em um link curto do nome de domínio tinyurl.com | `Link curto`, `URL curto` |
| [Ferramenta Waka](https://www.wakatool.com/maker) | Criador de emoticons online com funções poderosas, operação simples e materiais ricos |
| [Dunnnk](http://dunnnk.com) | Gere algumas imagens de exibição de produtos em alguns dispositivos. Basta fazer upload de suas próprias fotos. Atualmente, dispositivos relacionados a iOS e telefones Android são suportados | |
| [Bitbug](http://www.bitbug.net/) | Gerar ícone ico | `geração de ico` |
| [Imagem compactada](https://www.yasuotu.com/buttonColor) | Ferramenta de remoção de cor de fundo de imagem on-line (foto, ícone), que pode remover a cor de fundo de imagens de cores sólidas gratuitamente | `Compressão de imagem` , `Conversão de formato`, `Operação de imagem` |
| [Whimsical](https://whimsical.com/) | Desenhe fluxogramas colaborativos, wireframes, notas e mapas mentais online |
| [gerador de URL curto t.cn](http://qvni.cn/t.cn/) | Pode converter o URL em um link curto do nome de domínio t.cn | `link curto`, `URL curto`, `t.cn` |
| [cloudconvert](https://cloudconvert.com/mkv-to-mp4) | Converta arquivos de vídeo para o formato MP4 online, gratuitamente e sem necessidade de registro | `Conversão de vídeo`, `MP4` |
| [Meu novo logotipo](https://mybrandnewlogo.com/logo-maker) | Crie um logotipo em 30 segundos que pode ser usado para diversos fins |
| [Jikipedia](https://jikipedia.com/) | Para pesquisar palavras-chave da Internet, acesse Jikipedia. O Dicionário Xiaoji concentra-se na coleta e interpretação de chavões da Internet e captura as palavras atuais da Internet em toda a Internet o mais rápido possível. De forma simples, clara e de fácil compreensão, o significado, a origem, o processo de disseminação e o significado ampliado dos chavões da Internet são apresentados aos usuários. Os usuários podem não apenas entender os termos da Internet por meio do Dicionário Xiaoji, mas também entrar em contato com diferentes culturas populares, como gírias de nicho, novos memes, termos de barragem, dialetos e gírias, bem como novas interpretações de palavras antigas criadas independentemente por internautas. | `Chavões`, `Memes` |
...
| [pond5](https://www.pond5.com) | Pond5 é um site de material abrangente que fornece fotos, ilustrações, músicas, efeitos sonoros, modelos AE, modelos 3D, vídeos e outros recursos. em materiais de efeitos sonoros, seus materiais também são divididos em conteúdo gratuito e pago. É claro que esses conteúdos são protegidos por direitos autorais. | `fotos`, `ilustrações`, `efeitos sonoros`, `modelos` |
| [biblioteca de efeitos sonoros](http://www.sound-effects-library.com) | Portal profissional recomendado por colegas, você mesmo pode pesquisar |
| [videohive](https://videohive.net) | videohive também é um portal de materiais abrangente. Claro, além dos efeitos sonoros, também são fornecidos muitos materiais de efeitos especiais. e a versão internacional Os materiais de conteúdo são de alta qualidade e ricos em variedade, e todos os materiais exigem pagamento. No entanto, os materiais deste site são realmente de alta qualidade e há muitos efeitos de áudio e vídeo que merecem referência. | `Efeito de Som e Imagem` |
| [Rede de Som](http://www.shengyin.com) | |
| [AiGi.com](http://www.2gei.com) | |
| [Rede de efeitos sonoros](http://www.yinxiao.com) | |

## Passe os efeitos especiais

| Nome do site | Descrição |
|------------------|---------------------| 
| [2018 Make Me Pulse](http://2018.makemepulse.com/) | Use canvas para desenhar os quatro números de 2018, os efeitos especiais são ótimos | `canvas`, `2018` |
| [Alinti](http://preview.themeforest.net/item/alinti-minimal-creative-wordpress-portfolio/full_screen_preview/17753077) | Use fotos em preto e branco de alta definição ou imagens de fundo para simplificar o design da web em preto e branco , páginas simples em WordPress em preto e branco Modelo de design `Preto e branco` |
| [animatable](http://leaverou.github.io/animatable/) | Uma propriedade CSS e dois valores podem produzir vários efeitos especiais incomuns |
| [Ant Design Pro](https://motion.ant.design/) | Ant Design Pro foi lançado oficialmente e o efeito interativo de seu site oficial é ótimo. |
| [GAMECORES](https://www.g-cores.com/) | GAMECORES, o primeiro jogo abrangente da China (principalmente jogos de console importantes), sites e fóruns de transmissão on-line relacionados a jogos e fornece aos jogadores o que há de mais recente e mais recente áudio, vídeo e relatórios ao vivo oportunos. | `Jogo` |
| [Vue Conf](https://vue.w3ctech.com/#about) | Os efeitos de foco dos alto-falantes são únicos |
| [Sr. Yeehee](https://www.yeehee.cn/) | Existem muitos artigos relacionados ao WordPress e pequenos programas, e os efeitos especiais do site são muito bons |
| [Xiaoyaoyun](https://idc.yygzs.cn/) | Provedor de servidor em nuvem, há muitos efeitos de foco no site |
| [Sr. Limi](https://blog.limiabc.com/) | tema wordpress, blog pessoal do designer, simples e elegante, cheio de criatividade |
...
| Nome do site | Descrição |
|------------------|---------------------| 
| [M Theme](http://mzhuti.com/) | A M Theme Mini Program Station fornece downloads de modelos de miniprogramas WordPress de alta qualidade para ajudar mais webmasters WordPress a usar miniprogramas. | `Mini programa`, `Wordpress`, `modelo` |
| [Alinti](http://preview.themeforest.net/item/alinti-minimal-creative-wordpress-portfolio/full_screen_preview/17753077) | Use fotos em preto e branco de alta definição ou imagens de fundo para simplificar o design da web em preto e branco , páginas da web simples em WordPress em preto e branco Modelo de design `Preto e branco`, `Simples` |
| [famethemes](https://www.famethemes.com/) | Fornece alguns temas WordPress elegantes, limpos e bonitos, incluindo `temas` gratuitos e pagos |
| [ShieldsIO](https://shields.io/) | Fornece muitos emblemas para Github e WordPress, com uma variedade de funções personalizadas |
| [Salong Network](https://salongweb.com/) | Concentre-se no design e desenvolvimento de temas WordPress de alta qualidade, fornecendo a você um site WEB moderno e limpo! | `tema` |
| [Sr. Limi](https://blog.limiabc.com/) | tema wordpress, blog pessoal do designer, simples e elegante, cheio de criatividade |
...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [All History](https://www.allhistory.com/) | All History (Allhistory) usa o gráfico de conhecimento de IA como mecanismo principal para construir e exibir conteúdo de humanidades digitais por meio de métodos de dados altamente espaço-temporais e correlacionados, especialmente conhecimento histórico. Permitir que os usuários mergulhem em um oceano de conhecimento (história, humanidades, ciências sociais, etc.) vasto e pitoresco. | `Mapa do Conhecimento`, `Conhecimento Histórico` |
| [@bosslogic](https://www.instagram.com/bosslogic/) | Este é um mestre, 90% dos pôsteres não oficiais da Marvel que você vê online podem ser dele |
| [AYNU Music Lab](http://mu.aynu.top/) | Reprodutor de música online gratuito. Ele contém as músicas sem perdas mais recentes de toda a Internet e oferece downloads gratuitos de músicas MP3 sem perdas. Você pode desfrutar da reprodução e download gratuitos de músicas de toda a Internet sem abrir uma conta VIP! | `Reprodutor de música`, `Download de música` |
| [BD Film and Television](https://www.bdys.co/) | Fornece principalmente uma grande variedade de recursos de filmes e televisão para download e pode ser visualizada online. A versão da arma será lançada dentro de três meses após o lançamento. , e a versão em Blu-ray de alta definição será lançada três meses depois Download |
| [BTtwo](http://v.apkgm.top/) | Existem muitos filmes e séries de TV, e eles também oferecem visualização online |
| [Cheatography](https://www.cheatography.com/) | Existem mais de 4.000 tabelas de comparação neste site, incluindo Linux, MySQL, Vim, etc. |
| [Olá Github](https://hellogithub.com/) | Compartilhe projetos de código aberto interessantes e básicos no GitHub | `Github`, `Projetos de código aberto` |
...
| [Xilinjie](https://www.xilinjie.com/) | Xilinjie pode não apenas pesquisar e-books, mas também pesquisar [Disco de Rede], [Vídeo], [Mooc], etc. Além disso, você também pode pesquisar pesquisas acadêmicas correspondentes, o que traz comodidade aos pesquisadores científicos. | `e-book`, `acadêmico`, `netdisk` |
| [Jiumodiary](https://www.jiumodiary.com/) | Jiumodiary é um poderoso mecanismo de busca de e-books na China, cobrindo a maioria dos recursos de e-books, com uma interface simples e sem assédio publicitário. Além disso, você pode baixar diretamente e-books nacionais e estrangeiros sem registro, e alguns livros também possuem versões de leitura online. | `e-book`, `leitura online` |
...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [Navegação Youshe](http://hao.uisdc.com/) | A navegação do site Youshe fornece aos designers tutoriais PS, design de interface do usuário, downloads de materiais, galerias de alta definição, esquemas de cores, experiência do usuário, web design, etc. guia de navegação para designers. Atualizado em tempo hábil todas as semanas, é a navegação de designer mais prática, profissional, abrangente e fácil de usar da Excellent Design Alliance (SDC)! | `Desenhista` |
| [Qianshan](http://qianshan.co/) | Qianshan é uma navegação simples no site. Sem anúncios, pop-ups e informações redundantes, Qianshan espera ser o caminho mais curto para o desconhecido. Com teclas de atalho para ir diretamente ao site e um clique para abrir várias guias, Qianshan está disposto a economizar cada minuto e cada segundo. | `Navegação no site` |
| [Blog](http://www.jetli.com.cn/) | O site foi criado em 2006 e se concentra na coleta de blogs pessoais independentes excelentes, valiosos e eficazes. | `Blog pessoal` |
| [Miguyu](http://www.miguyu.com) | Miguyu, um site que compartilha links úteis Aqui você pode descobrir mais sites excelentes e úteis e coletar seus links favoritos.  | `Links úteis` |
| [Big Data Navigation](http://hao.199it.com/) | Big Data Navigation, com foco na indústria de big data e complementada por ferramentas de big data, fornece aos usuários uma plataforma de ferramentas para encontrar ferramentas relacionadas a big data mais rapidamente . | `Ferramentas de Big Data` |
| [WeChat Treasure Box](http://wxbbx.jh1z.com/) | Um think tank para funcionários do WeChat, que coleta ferramentas relacionadas ao WeChat, incluindo editores, geradores de código QR, plug-ins, etc. | `Ferramentas WeChat` |
| [Micro Navegação](http://www.we123.com/) | A melhor coleção de miniprogramas WeChat, com a coleção mais completa e a classificação mais precisa. É uma enciclopédia WeChat e uma coleção de códigos QR WeChat que integra a mini loja de programas WeChat, minijogos WeChat, plataforma de conta pública WeChat, site oficial do WeChat e micro URL. A conta do aplicativo WeChat, a conta de assinatura do WeChat e a conta de serviço do WeChat são uma combinação perfeita. Há também manchetes do WeChat, enciclopédia de negócios do WeChat e essência do WeChat, todos incluídos em uma única parada. | `Mini Programa WeChat` |
| [Navegação tecnológica](https://www.daohangtx.com/) | A plataforma líder de navegação e classificação para tutoriais técnicos e atividades na China. O site incluiu milhares de sites e forneceu centenas de milhões de cliques de acesso para internautas chineses. , satisfazendo as necessidades dos internautas chineses, os usuários podem acessar os artigos e tutoriais informativos mais abrangentes e confiáveis ​​a qualquer momento |
| [Conjunto de Eficiência](http://www.xiaolvji.com/) | Conjunto de Eficiência é um site de navegação que permite agregar recursos da Internet, compartilhar recursos da Internet e pode ser altamente personalizado. Você pode personalizar a navegação do site e o mecanismo de pesquisa da página inicial, e também vem com notas e tarefas online. Através da pesquisa agregada de conjuntos de eficiência, você pode comprar e comparar preços, assistir filmes online, dicionários online, tradução online, etc. Através do conjunto de eficiência, você também pode compartilhar seus sites favoritos com outras pessoas |
| [Instant Noodle Bar](http://www.paomianba.com/) | Instant Noodle Bar, uma marca de navegação educacional online, atende empreendedores e investidores na indústria de educação online. Promova a comunicação para que todos possam entender a dinâmica de sites educacionais online famosos, como macarrão instantâneo.  | `Navegação Educacional` |
| [Xuan Yuan](https://oo1.win/) | Filmes, nuvens, música, software, plug-ins de navegador, entretenimento, aprendizagem e outros tipos de navegação em sites |
| [Longxuan Navigation](http://ilxdh.com/) | Longxuan Navigation fornece a plataforma de recursos mais rápida, permitindo que você encontre rapidamente os recursos que deseja, com precisão, conveniência e rapidez | `Recursos` |
...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [LANZOUYUN](https://www.lanzous.com/b749444) | Coletou alguns pacotes apk de software para assistir vídeos gratuitamente |
| [Mai Krypton School](https://www.waitsun.com/) | Comprometida em compartilhar excelentes softwares de aplicativos para Mac, apresentando habilidades de uso do Mac, compartilhando o software Mac mais valioso gratuitamente e fornecendo downloads gratuitos dos mais recentes crackings para Mac Programas . | `Software Mac`, `Aplicativo Mac` |
| [Download futuro para Mac](https://mac.orsoon.com/) | Existem os melhores downloads de software para Mac e downloads de jogos para Mac |
| [Xclient](https://xclient.info/) | Compartilhando aplicativos MAC de alta qualidade, compartilhando um grande número de software Mac todos os dias, fornecendo software Mac de alta qualidade, serviços de download de software gratuitos | `aplicativos gratuitos` |
| [fastsoso](https://www.fastsoso.cn/) | Você pode pesquisar recursos de disco de rede. Embora seja um download pago, é muito barato, equivalente a apenas alguns centavos |
| [Assistente de disco em nuvem](https://www.yunpanjingling.com/) | fastsoso - Concentre-se na pesquisa de disco de rede Baidu, ferramenta de pesquisa de disco de rede em nuvem Baidu, você pode pesquisar vídeos, músicas, fotos, software, documentos, Recursos como sementes e álbuns tornam o compartilhamento e o download do disco na nuvem do Baidu mais conveniente e rápido, e são mais fáceis de usar do que o comando site:pan.baidu.com. | `Netdisk`, `filme`, `vídeo` |
| [CEIC](https://www.ceicdata.com/zh-hans) | Cobertura sem precedentes de dados econômicos (macroeconomia, PIB, importação e exportação, energia, etc.) para mais de 195 países e regiões ao redor do mundo. O CEIC ajuda você a obter milhões de dados de séries temporais de milhares de fontes de dados em uma única parada, e a equipe de atendimento ao cliente ajuda a encontrar ou interpretar as informações de dados desejadas. «Dados Económicos» |
| [6v Movie Network](http://www.6vhao.tv/) | Assista e baixe bons filmes, séries de TV e programas de variedades online, e você também pode verificar a lista de exibição | `programas de variedades` |
| [Ant Design Landing](https://landing.ant.design/index-cn) | A plataforma possui uma grande variedade de modelos de página inicial. Você também pode baixar o pacote de código do modelo e usá-lo rapidamente. editor para construí-lo rapidamente Uma página inicial exclusiva que pertence a você |
| [ClipConverter.cc](https://www.clipconverter.cc/) | Baixe um único vídeo do Youtube, suportando vários formatos e definições. | `Baixar vídeo do YouTube` |
| [down](http://www.jqhtml.com/down/) | Fornece downloads gratuitos de alguns livros na área de informática, principalmente livros front-end. | `Baixar livro` |
| [Baixar sem marca d'água](https://www.studyjava.cn/douyin) | Suporta download sem marca d'água de vídeos como Douyin, Kuaishou, Weishi, etc. | `Baixar sem marca d'água` |
| [iData](https://www.cn-ki.net/) | Recuperação de conhecimento iData - download gratuito de documentos acadêmicos, download gratuito do CNKI, o maior espelho CNKI do mundo. | `Documentos Acadêmicos` |
| [Sub HD](http://subhd.com/) | Sub HD fornece uma plataforma para os amantes de cinema e televisão trocarem legendas. Aqui você pode encontrar e baixar legendas, avaliar e comentar sobre as legendas e fazer upload de legendas para compartilhar. com outros. | `Legendas` |
| [wallhaven.cc](https://alpha.wallhaven.cc/random) | Download de papel de parede de computador |
| [Qiaobu Resume](http://cv.qiaobutang.com/) | Qiaobu Resume fornece aos estudantes universitários e recém-formados os mais recentes e completos modelos de currículo pessoal em chinês e inglês para download gratuito em vários setores, bem como um um grande número de informações sobre currículos Os artigos sobre habilidades de redação são dedicados a ajudar os candidatos a emprego a criar currículos mais profissionais. | `Modelo de currículo`, `Habilidades de currículo` |
| [Hiwenku](http://doc.hiwenku.com/) | Suporta download gratuito de documentos do Baidu Wenku e suporta download de arquivos originais em word, PPT, excel e outros formatos. | `Biblioteca Baidu` |
| [Kengso.com](http://www.kengso.com/) | Kengso.com Netdisk search é um mecanismo de pesquisa profissional em nuvem do Baidu que coleta Baidu Cloud, Baidu Netdisk e outros recursos em tempo real e atualiza vários recursos de alta qualidade. filmes de definição todos os dias, vídeos, sementes, romances e outros recursos de disco de rede, a verdadeira ferramenta de pesquisa de disco de rede que você entende! `Nuvem Baidu`, `Netdisk` |
| [Tiantian Mei Drama](http://www.ttmeiju.vip/) | Tian Tian Mei Drama (ttmeiju.vip) fornece os downloads de dramas americanos de alta definição mais populares e mais recentes e dramas americanos de alta definição para assistir online. Tiantian Mei Drama é uma organização sem fins lucrativos para amantes de dramas sexuais americanos, nosso objetivo é: compartilhar felicidade e criar a principal plataforma doméstica de compartilhamento de fontes de drama americano BT |
| [Biblioteca de legendas](https://www.zimuku.cn/) | Download de legendas| `Legendas` |
| [Grupo de legendas](http://www.zimuzu.tv/) | O site do grupo de legendas é um site criado por membros entusiastas. Ele continuará traduzindo para você as legendas de filmes e dramas de televisão estrangeiros mais recentes e mais rápidos, dramas americanos. , dramas japoneses e as últimas legendas de filmes Baixar `Legendas` |
| [Primeiro site de filmes](http://www.dysfz.vip/) | O melhor site de download de filmes em alta definição na China, atualizado todos os dias com filmes Thunder com legendas em chinês e inglês para download em disco na nuvem Baidu, coleta e compartilhamento de alta qualidade Filmes legendados em chinês e inglês de definição O Baidu Cloud Disk Download Station está comprometido em construir o maior local de encontro para download de filmes em alta definição. Downloads de filmes Thunder e downloads gratuitos de filmes estão todos na estação de download de filmes em alta definição, o primeiro site de filmes. | `Download de filme`, `Disco de rede` |
| [Green Apple Cinema](https://www.qpg123.com/) | Green Apple Cinema é o site de filmes mais recente e abrangente. Os downloads do Thunder são gratuitos para assistir filmes a qualquer hora e em qualquer lugar. serviços de visualização. | `filme` |


## Aprenda e jogue ao mesmo tempo

| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [Check iO](https://checkio.org/) | Um jogo da web que requer o uso de Python ou Javascript para avançar |
| [Code Monkey](https://www.playcodemonkey.com/) | Pegue bananas escrevendo códigos. Usado principalmente por professores para ensinar os alunos a aprender programação. (Pago) | `Aprendizagem Paga` |
| [Codewars](https://www.codewars.com/) | Alcançar o objetivo de dominar gradualmente as linguagens de programação através de desafios práticos com outras pessoas. Suporta JavaScript, Python, C#, Java, Python, etc. | `Desafio` |
| [CodinGame](https://www.codingame.com/start) | Resolva problemas desafiadores de codificação, suportando basicamente todas as linguagens de programação. | `Problema de codificação` |
| [Cyber ​​​​Dojo](http://www.cyber-dojo.org/) | Um lugar para programadores praticarem programação, suportando JavaScript, Java, Python, PHP, Ruby, etc. | `Praticar programação` |
| [Elevator Saga](http://play.elevatorsaga.com/) | Um jogo de elevação de elevadores que resolve problemas passo a passo. Por exemplo, no primeiro nível, você tem que transportar 15 pessoas em até 60 segundos. | `Jogo do Elevador` |
| [Flexbox Defense](http://www.flexboxdefense.com/) | Um jogo de defesa que usa atributos de posicionamento do Flexbox para defesa | `Flexbox` |
| [Flexbox Froggy](http://flexboxfroggy.com/) | Use propriedades relacionadas ao CSS para ajudar o sapo a atravessar o rio |
| [Screeps](https://screeps.com/) | Aprenda JavaScript jogando. Diz-se que é o primeiro jogo sandbox online multijogador massivo do mundo para programadores. | `Jogo Sandbox Online`, `Javascript` |
| [The Bezier Game](https://bezier.method.ac/) | No The Bezier Game, primeiro demonstre o método de desenho da curva de Bezier por meio de animação e depois tente desenhá-la você mesmo. Para se registrar e ver o prompt de demonstração, pressione Shift ou Alt. | `Curva de Bézier` |
| [Vim Adventures](https://vim-adventures.com/) | Aprenda Vim em jogos |
| [Jogo XSS](https://xss-game.appspot.com/) | Aprenda sobre ataques XSS e como se defender deles através de jogos |
| [Geek Combat](https://codecombat.com/play) | Uma plataforma para os alunos aprenderem ciência da computação jogando jogos reais. É um projeto mantido por milhares de jogadores de forma voluntária. Suporta Java, JavaScript, Python, Lua, CoffeeScript. | `Jogos`, `Ciência da Computação` |
...
| Nome do site     | Descrição           | Tags                |
|------------------|---------------------|---------------------|
| [Clippy](https://bennettfeely.com/clippy/) | Gerador visual de clip-path em CSS |
| [Postwoman](https://postwoman.io/) | Construtor de solicitações que ajuda você a criar solicitações com mais rapidez, economizando um tempo valioso de desenvolvimento. | `Solicitação`, `Carteiro` |
| [Swagger](https://swagger.io/) | No desenvolvimento de todo o ciclo de vida da API, desde o design e documentação até o teste e implantação, são fornecidas ferramentas e soluções correspondentes |
| [bundlephobia](https://bundlephobia.com/) | Detecção online do custo de adição de um pacote NPM, incluindo tamanho do pacote e tempo de download |
| [AST Explorer](https://www.wakatool.com/maker) | Navegue pelos resultados do AST online, com suporte para vários idiomas | `AST` |
| [Stackblitz](https://stackblitz.com/) | Edição online, a principal vantagem é que é muito conveniente selecionar a estrutura necessária |
| [Express Route Tester](http://forbeslindesay.github.io/express-route-tester/) | Pode verificar se a rota Express está escrita corretamente |
| [Introdução ao GIT que até um macaco pode entender](https://backlog.com/git-tutorial/cn/) | Introdução ao Git super simples, incluindo capítulo introdutório, capítulo avançado e índice do Git, com conteúdo abrangente | `Git` ,`tutorial` |
| [ASCIIFlow Infinity](http://asciiflow.com/) | Use caracteres ASCII para desenhar, você pode ajustar o tamanho, desenhar livremente e desenhar códigos semelhantes a Buda. | `ASCII`, `código` |
| [autoprefixer](http://autoprefixer.github.io/) | Gere código compatível com CSS online, que na verdade é a versão online do autoprefixer. . | `compatível`, `autoprefixador` |
| [BIOMES](https://demo.marpi.pl/biomes/) | Use WebGL para gerar terreno voxel abstrato |
| [Posso usar](https://caniuse.com/) | Fornece consulta de status de suporte do navegador para tecnologia Web moderna |
| [Carbon](https://carbon.now.sh) | Gere imagens de código estilo Mac para compartilhamento | `Mac`, `code` |
| [Tabela de referência de entidades de caracteres](https://dev.w3.org/html5/html-author/charref) | Tabela de caracteres de escape para vários símbolos |
| [Escolha uma licença](https://choosealicense.com/) | Forneça sugestões para sua escolha de licença de código aberto com base em várias questões |
| [CODELF](https://unbug.github.io/codelf/) | Artefato de nomenclatura de projetos, você pode pesquisar nomes de projetos no github, gitlab e outros sites por palavras-chave | `Naming` |
| [CSS Sprite Generator](https://spritegen.website-performance.org/) | Ferramentas para gerar imagens sprite e CSS correspondente online |
| [Gerador de triângulo CSS](http://apps.eky.hk/css-triangle-generator/zh-hant) | Gerador de triângulo CSS |
| [CSS Triggers](https://csstriggers.com/) | Lista o impacto de várias propriedades CSS no refluxo e no redesenho em diferentes mecanismos de navegador |
| [css-selectors-cheatsheet](https://frontend30.com/css-selectors-cheatsheet/) | Um total de mais de uma dúzia de perguntas para testar seu domínio de seletores CSS |
| [Desenho de curva de animação CSS](http://yisibl.github.io/cubic-bezier/#.17,.67,.83,.67) | `animação CSS`, `curva de Bézier`, `cúbic-bezier` |
| [Analisador esprima](http://esprima.org/demo/parse.html) | Inserir instruções JS pode gerar imediatamente a árvore de sintaxe abstrata (AST) que precisamos |
| [GitPunch](https://gitpunch.com/) | Ele personalizará a biblioteca de pacotes npm que você deseja rastrear e você também poderá enviar notificações por e-mail regularmente |
| [nginxconfig.io](https://nginxconfig.io/) | Gere arquivos de configuração nginx online, você pode escolher o idioma e as funções, e o site é de código aberto. |
| [No-Cruft Excel to HTML Table Converter](http://pressbin.com/tools/excel_to_html_table/index.html) | Pode colar dados de planilha do Excel (ou tabela HTML) e convertê-los sem qualquer formatação de nova tabela HTML. | `HTML`, `Tabela` |
| [PXtoEM](http://pxtoem.com/) | Conversor de unidades PX e EM |
| [Regex101](https://regex101.com/) | Teste expressões regulares online |
| [SassMeister](https://www.sassmeister.com/) | Sass é compilado online, mas o site é um pouco feminino. . | `Sass`, `Compilar` |
| [ShieldsIO](https://shields.io/) | Fornece muitos emblemas para Github e WordPress, com uma variedade de funções personalizadas |
| [Laboratórios SSL](https://www.ssllabs.com/ssltest/analyze.html) | Realizar análises aprofundadas de servidores Web SSL, mas leva muito tempo |
| [Ferramenta SSL Online](http://www.ssleye.com/) | Suporta verificação online de 15 algoritmos de criptografia simétrica, geração de pares de chaves públicas e privadas, conversão mútua de PKCS1 e PKCS8, geração e visualização de CSR, visualização de certificado , etc. Recursos | `SSL` |
| [TablesGenerator](http://www.tablesgenerator.com/) | Geração visual online de tabelas LateX, Markdown e HTML |
| [Toolfk Online Toolbox](https://www.toolfk.com/) | Uma caixa de ferramentas para programadores contendo dezenas de ferramentas práticas. | `Coleção de ferramentas` |
| [Gerador de camada de gradiente](https://codepen.io/pissang/full/geajpX) | Você pode ajustar vários parâmetros da camada de gradiente diretamente arrastando-a com o mouse e exportando-a para o formato SVG. | `Gradiente` |
| [Folha de dicas da função de atenuação](https://easings.net/) | Uma introdução vívida a várias funções de atenuação e é de código aberto |
| [Biblioteca de animação front-end da Meitu](http://f2er.meitu.com/animastore/) | A biblioteca de animação produzida pela equipe de front-end da Meitu coleta algumas animações simples e práticas, e você pode copiar diretamente o código | `Animação` |
